             ...
             <div class="col-lg-10">
	            <div class="btn-group" data-toggle="buttons">
	                <label class="btn btn-default">
	                    <input type="radio" id="q156" name="pay" value="1" /> 신용카드
	                </label> 
	                <label class="btn btn-default">
	                    <input type="radio" id="q157" name="pay" value="2" /> 계좌이체
	                </label> 
	                <label class="btn btn-default">
	                    <input type="radio" id="q158" name="pay" value="3" /> 기타
	                </label> 
	                <label class="btn btn-default">
	                    <input type="radio" id="q159" name="pay" value="4" /> 외상
	                </label> 
	            </div>
	            </div>
            </div>
