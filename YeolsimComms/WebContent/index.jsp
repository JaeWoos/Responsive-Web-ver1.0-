...
<%@ page import="com.yeolsim.service.product.ProductService" %>
<%@ page import="com.yeolsim.service.product.impl.ProductServiceImpl" %>
          ...
          <form class="navbar-form navbar-right" id="loginform" action="/login.do" method="post">
            ...
            <div class="form-group">
		      ...
		      <button id="login" type="submit" class="btn btn-success" >Sign in</button>
		       <a href="/member/member.jsp"><button id="member" type="button" class="btn btn-success">Sign up</button></a>
          </form>
        </div><!--/.navbar-collapse -->
      </div>
    </nav>
